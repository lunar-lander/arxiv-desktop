      ...
      submenu: [
        ...
        { type: 'separator' },
        {
          ...
          click: async () => {
            ...
            if (!result.canceled) {
              mainWindow.webContents.send('menu-action', 'import-papers', result.filePaths);
            }
          }
        },
        { type: 'separator' },
      ...
      submenu: [
        {
          ...
          click: () => {
            mainWindow.webContents.send('menu-action', 'show-bookmarks');
          }
        },
        {
          label: 'Show Starred',
        ...
        { type: 'separator' },
        {
          ...
          click: async () => {
            const choice = await dialog.showMessageBox(mainWindow, {
              ...
              detail: 'This will remove all downloaded papers from your local storage.'
            });
